...
4.  **Automated Quality Gates:** Generate configuration for a standard linter and code formatter for my project's language (e.g., `lint` + `fmt` blocks in `vite.config.ts` for Vite+/Oxlint/Oxfmt). This ensures future code stays clean.
