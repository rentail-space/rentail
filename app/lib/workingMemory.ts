...
const userProfile = zod.object({
  ...
  location: zod
    .object({
      latitude: zod.string().optional().describe("The user's latitude"),
      longitude: zod.string().optional().describe("The user's longitude"),
      city: zod.string().optional().describe("The user's city"),
      state: zod.string().optional().describe("The user's state"),
      timezone: zod.string().optional().describe("The user's timezone"),
    })
    .describe("The user's location"),
  selling: zod.object({
    productType: zod.string().optional().describe("The user's product type"),
    pricePoint: zod.string().optional().describe("The user's price point"),
    targetAudience: zod
      .string()
      .optional()
      .describe("The user's target audience"),
  }),
