      ...
      <header className="py-4 border-b border-gray-200">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center">
            <a href="/" className="text-2xl font-bold text-blue-600">RenTail</a>
          </div>
          <nav className="hidden md:flex space-x-8">
            <a href="#features" className="font-medium text-gray-600 hover:text-blue-600">Features</a>
            <a href="#how-it-works" className="font-medium text-gray-600 hover:text-blue-600">How It Works</a>
            <a href="#pricing" className="font-medium text-gray-600 hover:text-blue-600">Pricing</a>
            <a href="#contact" className="font-medium text-gray-600 hover:text-blue-600">Contact</a>
          </nav>
          <div className="hidden md:flex items-center space-x-4">
            <a href="#login" className="px-4 py-2 rounded font-medium text-blue-600 hover:text-blue-800">Sign in</a>
            <a href="#signup" className="px-4 py-2 rounded bg-blue-600 text-white font-medium hover:bg-blue-700">Get Started</a>
          </div>
        </div>
      </header>
      ...
      <footer className="bg-gray-100 py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">RenTail</h3>
              <p className="text-gray-600">Simple rental platform for your needs.</p>
            </div>
            <div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 text-center text-gray-500">
            <p>© {new Date().getFullYear()} RenTail. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </>
