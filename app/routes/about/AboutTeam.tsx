      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
        {team.map((member) => (
          <Link
            ...
            to={member.linkedIn}
            target="_blank"
            className="flex transform flex-col items-center rounded-md border-2 border-black bg-white p-8 text-center shadow-[4px_4px_0px_0px_black] transition-all duration-100 hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_black]"
          >
            ...
            <h3 className="mb-1 font-bold text-black text-xl">{member.name}</h3>
